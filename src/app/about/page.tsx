...
import { Building2, ShieldCheck, Award, MapPin, CheckCircle, ArrowRight } from 'lucide-react';
      ...
      <section className="bg-slate-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
          <span className="text-emerald-400 text-xs font-bold uppercase tracking-widest bg-emerald-950 px-3 py-1 rounded-full border border-emerald-800">
            About Nobodhara Aryan Society
          </span>
          <h1 className="text-3xl sm:text-5xl font-extrabold">
            আমাদের পরিচিতি ও লক্ষ্য
          </h1>
          <p className="max-w-2xl mx-auto text-slate-300 text-sm leading-relaxed">
            নবধারা আরিয়ান সোসাইটি (Nobodhara Aryan Society) একটি বিশ্বস্ত ও পরিকল্পিত মডেল টাউন আবাসন প্রকল্প।
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-extrabold text-slate-900 leading-tight">
              নিরাপদ বিনিয়োগ ও আধুনিক নাগরিক জীবনের নিশ্চয়তা
            </h2>
            ...
            <div className="pt-4">
              <Link
                href="/plots"
                className="inline-flex items-center gap-2 bg-emerald-700 hover:bg-emerald-800 text-white font-bold px-6 py-3 rounded-xl transition shadow"
              >
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-slate-200">
            <img
              src="https://images.unsplash.com/photo-1524813686514-a57563d77965?w=1000"
              alt="Nobodhara Aryan Society Area"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 space-y-4">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                জমির কাগজপত্র, সিএস/আরএস খতিয়ান ও মূল্য নির্ধারণে পূর্ণাঙ্গ স্বচ্ছতা বজায় রাখা হয়। কোনো গোপন চার্জ নেই।
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 space-y-4">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                নির্ধারিত সময়ের মধ্যে সড়ক উন্নয়ন, ইউটিলিটি লাইন স্থাপন এবং প্লট হস্তান্তর নিশ্চিত করা হয়।
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 space-y-4">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                প্রতিটি ব্লকে পার্ক, খেলার মাঠ, ওয়াটার বডি এবং কমিউনিটি সেন্টারের জন্য বিশেষ জায়গা সংরক্ষিত।
              </p>
            </div>
          </div>
